...
exports.stakeCreditAbi = [
    ...
    { inputs: [], name: "NoClaimableUnbondRequest", type: "error" },
    { inputs: [], name: "NoUnbondRequest", type: "error" },
    { inputs: [], name: "OnlyCoinbase", type: "error" },
    {
        inputs: [
            { internalType: "address", name: "systemContract", type: "address" },
        ],
        name: "OnlySystemContract",
        type: "error",
    },
    { inputs: [], name: "OnlyZeroGasPrice", type: "error" },
    { inputs: [], name: "OutOfBounds", type: "error" },
    { inputs: [], name: "RequestExisted", type: "error" },
    ...
    { inputs: [], name: "WrongInitContext", type: "error" },
    { inputs: [], name: "ZeroAmount", type: "error" },
    { inputs: [], name: "ZeroShares", type: "error" },
    { inputs: [], name: "ZeroTotalPooledBNB", type: "error" },
    { inputs: [], name: "ZeroTotalShares", type: "error" },
    {
        anonymous: false,
        inputs: [
            {
    ...
    {
        inputs: [
            { internalType: "address payable", name: "delegator", type: "address" },
    ...
    {
        inputs: [
            { internalType: "uint64", name: "commissionRate", type: "uint64" },
        ],
    ...
    },
    {
        inputs: [
            ...
            { internalType: "string", name: "_moniker", type: "string" },
        ],
        name: "initialize",
        outputs: [],
        stateMutability: "payable",
    ...
    {
        inputs: [
            { internalType: "uint256", name: "slashBnbAmount", type: "uint256" },
        ],
        name: "slash",
        outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
        stateMutability: "nonpayable",
        ...
        outputs: [
            {
                ...
                internalType: "struct StakeCredit.UnbondRequest",
                name: "",
                type: "tuple",
            },
        ],
